...
func init() {
	...
	utilruntime.Must(quayv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "repositorymirror.quay.ayoy.se",
	})
	if err != nil {
	...
	if err = (&controller.RepositoryMirrorReconciler{
		...
		QuayClientFunc: quay.NewClient,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RepositoryMirror")
		os.Exit(1)
	}
